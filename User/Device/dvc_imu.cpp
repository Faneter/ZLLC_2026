...
void Class_IMU::TIM1msMod50_Alive_PeriodElapsedCallback(void)
{
    ...
    {
        if ((Pre_BMI088_Raw_Data.Accel[0] == BMI088_Raw_Data.Accel[0]) && (Pre_BMI088_Raw_Data.Accel[1] == BMI088_Raw_Data.Accel[1]) && (Pre_BMI088_Raw_Data.Accel[2] == BMI088_Raw_Data.Accel[2])) // 判断陀螺仪是否掉线
        {
